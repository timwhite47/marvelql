    ...
    return {
      ...
      comics: {
        ...
        resolve: function resolve(response, args) {
          ...
          return (0, _graphqlRelay.connectionFromPromisedArray)(character.comics(), args);
        }
      },
      series: {
    ...
    return {
      ...
      characters: {
        ...
        resolve: function resolve(root, args) {
          ...
          return (0, _graphqlRelay.connectionFromPromisedArray)(_character2.default.all(), args);
        }
      }
    };
  }
    ...
    return {
      ...
      comic: {
        ...
        resolve: function resolve(root, _ref2) {
          var id = _ref2.id;
          return _comic2.default.find(id);
        }
      },
      series: {
        type: seriesType,
        ...
        resolve: function resolve(root, _ref3) {
          var id = _ref3.id;
          return _series2.default.find(id);
        }
      }
    };
  }

    ...
    return {
      ...
      comics: {
        ...
        resolve: function resolve(data, args) {
          ...
          return (0, _graphqlRelay.connectionFromPromisedArray)(series.comics(args), args);
        }
      },
      events: {
        ...
        resolve: function resolve(data, args) {
          var series = new _series2.default(data);
          return (0, _graphqlRelay.connectionFromPromisedArray)(series.events(args), args);
        }
      }
    };
  }
    ...
    return {
      ...
      characters: {
        ...
        resolve: function resolve(data, args) {
          ...
          return (0, _graphqlRelay.connectionFromPromisedArray)(comic.characters(args), args);
        }
      }
    };
  }
    ...
    return {
      ...
      comics: {
        ...
        resolve: function resolve(data, args) {
          ...
          return (0, _graphqlRelay.connectionFromPromisedArray)(event.comics(args), args);
        }
      },
      ...
      characters: {
        ...
        resolve: function resolve(data, args) {
          var event = new _event2.default(data);
          return (0, _graphqlRelay.connectionFromPromisedArray)(event.characters(args), args);
        }
      }
    };
  }
  ...
  fields: function fields() {
    return {
      ...
      series: {
        ...
        resolve: function resolve(response, args) {
          var character = new _character2.default(response);
          return (0, _graphqlRelay.connectionFromPromisedArray)(character.series(args), args);
        }
      },
      events: {
        type: eventConnection,
    ...
    return {
      comics: {
        ...
        resolve: function resolve(root, args) {
          return (0, _graphqlRelay.connectionFromPromisedArray)(_comic2.default.all(args), args);
        }
      },
      series: {
        type: seriesConnection,
        args: _graphqlRelay.connectionArgs,
        resolve: function resolve(root, args) {
          return (0, _graphqlRelay.connectionFromPromisedArray)(_series2.default.all(args), args);
        }
      },
      ...
      events: {
        ...
        args: _graphqlRelay.connectionArgs,
        resolve: function resolve(root, args) {
          return (0, _graphqlRelay.connectionFromPromisedArray)(_event2.default.all(args), args);
        }
      },
